...
const AdminLogin = () => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    navigate("/admin/dashboard"); // after login go to admin dashboard
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-950 via-gray-900 to-gray-800 px-4">
      <div className="bg-gradient-to-br from-gray-900/90 via-gray-800/80 to-gray-900/90 rounded-2xl shadow-2xl p-8 w-full max-w-md border border-gray-700">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-3xl font-extrabold text-gray-100 tracking-wide">Admin Login</h1>
          <p className="text-gray-400 text-center text-sm mt-2">Login to manage ERP system</p>
        </div>

        {/* Form */}
        <form className="space-y-5" onSubmit={handleLogin}>
          <input type="email" placeholder="admin@college.com" className="w-full rounded-lg border border-gray-600 bg-gray-800/60 px-4 py-2 text-gray-100" />
          ...
          <button type="submit" className="w-full bg-gradient-to-r from-red-500 to-red-600 text-white font-semibold py-2 rounded-lg shadow-lg hover:scale-[1.02] transition">
            Login
          </button>
        </form>
        ...
        <p className="text-gray-400 text-sm mt-4 text-center">
          ...
          <Link to="/admin/signup" className="text-red-400 hover:text-red-300">Sign Up</Link>
        </p>
      </div>
    </div>
  );
